...
class TestGrafo(unittest.TestCase):
    ...
    def test_caminho_euleriano(self):
        ...
        self.assertEqual(self.g_c2.caminho_euleriano(), ['Maria', 'amiga', 'Nina'])
        ...
        self.assertEqual(self.g_pa.caminho_euleriano(), ['Vinicius', 'amizade1',
         'Joao', 'amizade2', 'Vinicius', 'amizade6', 'Maria', 'amizade4',
          'Isabella', 'amizade3', 'Joao', 'amizade5', 'Henrique', 'amizade7',
           'Isabella', 'amizade8', 'Henrique'])
